        ...
        <div className="col-md-6 ">
          <div className='bg-light p-3 rounded-3'>
            ...
            <p className='text-muted'>Please Enter Your Otp  or Check Your Inbox</p>
              ...
              <input  placeholder='OTP' className="form-control" type='text' {...register("seed",{required:true,minLength:6,maxLength:6})}/>
              ...
              <div className="form-group my-3">
              <input  placeholder='Enter your new password' className="form-control" name='password' type='password'{...register("password",{required:true,minLength:6})} onChange={newPasswordValue}  />
              ...
              <div className="form-group my-3">
              <input  placeholder='Confirm password' className="form-control" type='password' {...register("confirmPassword",{required:true,validate:value=> value==newPassword})} />
              {errors.confirmPassword?.type=="required"&&<span className='text-danger ps-1'>confirm password is required</span>}
              {errors.confirmPassword?.type=="validate"&&<span className='text-danger ps-1'>confirm password is mismatch new password</span>}
              </div>
